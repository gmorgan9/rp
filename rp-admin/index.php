              ...
              <div class="card quicklook">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <!-- </div> -->
                    <div class="pt-3"></div>
                    <p style="margin-bottom: -2px;">Ubuntu 22.0.4 running <a style="color: #7fade1; text-decoration: underline;" href="/">Recipe Pro</a></p>
                  </div>
                </div>
              </div>
            <!-- end quicklook -->
                ...
                <div class="card-body">
                  ...
                  <?php foreach ($options as $option) { ?>
                    <div class="row">
                      ...
                      <div class="col">
                        <p class="text-muted"><a style="color: #7fade1;" href="<?php echo BASE_URL . '/single_recipe.php?title=' . $option['short_title']; ?>"><?php echo $option['title']; ?></a></p>
                      </div>
                    </div>
                  <?php }} ?>
                  <!-- <hr> -->
                  ...
                  <?php foreach ($drafts as $draft) { ?>
                    <div class="row">
                      <div class="col ps-4">
                        <div class="d-flex">
                          <p>
                            <a style="color: #7fade1;" href="<?php echo BASE_URL . '/single_recipe.php?title=' . $draft['short_title']; ?>"><?php echo $draft['title']; ?></a> 
                          </p>
                          &nbsp;&nbsp;
