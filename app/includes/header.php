<div class="page-header position-fixed" style="width: 115%;">
    <div class="d-flex" style="float:left !important;">
        ...
        <div class="pe-4"></div>
        <a class="head-link" style="text-decoration: none; color: white;" href="/"><i class="head-link" style="color: #777;" class="bi bi-house-door-fill"></i>&nbsp;CacheUp</a>
        <div class="pe-4"></div>
        &nbsp;&nbsp;
    ...
    <!-- start dropdown -->
        <div class="dropdown-menu">
            ...
            <div class="menu-content" style="margin-top: 6px; margin-left: .5px;">
