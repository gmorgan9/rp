<div class="page-header d-flex">
    ...
    <div class="pe-4"></div>
    <a style="text-decoration: none; color: white" href="/"><i class="bi bi-house-door-fill"></i>&nbsp;CacheUp</a>
    <div class="pe-4"></div>
    ...
    <a class="float-end" style="text-decoration: none; color: white" href="/"><i class="bi bi-plus"></i>New</a>
</div>
