                ...
                <span>  Posts</span>
					...
					<div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
							<ul class="list-group-item">
								<li class="text-decoriation-none"><a href="#"> Add new</a></li>
								<li class="text-decoriation-none"><a href="#"> All Posts</a></li>
								<li class="text-decoriation-none"><a href="#"> Categories</a></li>
							</ul>
