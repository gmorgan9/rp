        ...
        <a href="<?php //echo BASE_URL . '/pages/dashboard.php' ?>" class="list-group-item list-group-item-action py-2 ripple" aria-current="true">
            ...
            <div class="accordion accordion-flush" id="accordionFlushExample">
                ...
                <div class="accordion-item">
                  ...
                  <button class="accordion-toggle" data-bs-auto-close="false" type="button" data-bs-toggle="accordian" data-bs-target="#flush-collapse1" aria-expanded="false" aria-controls="flush-collapse1">
                      POSTS
                    </button>
                  </h2>
