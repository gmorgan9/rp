...
<head>
    ...
    <link rel="stylesheet" href="assets/blog.css?v=5.16">
...
<!-- start blog recipes -->
    ...
    ?>
      ...
      <nav class="mt-4" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="mobile breadcrumb-item text-white text-uppercase" style="font-size: 12px;"><a href="category.php?id=<?php echo $cat; ?>" class="bc-link text-decoration-none text-uppercase text-white"><?php echo $name; ?></a></li>
          <?php
  ...
  <!-- Author Box -->
    ...
    <a class="mobile post-link" style="text-decoration: none; color: #58c5f7;" href="author.php?id=<?php echo $idno; ?>">
    <?php
  ...
  <!-- sidebar -->
    ...
    <div class="mobile side" id="side" style="float: right; top: 0; right: 0; margin-top: 0; margin-right: 0 !important; padding-right: 0 !important; background-color: #1f1f1f; width: 30%;">  
