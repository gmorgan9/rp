        ...
        <a class="text-decoration-none text-white" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
          ...
          <div class="dropdown-menu p-4" >
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="display:table !important; width:100%;">
                <li class="nav-item text-center btn-dark" style="display: table-cell;
       background: #0d6efd2e;">
                  <a class="btn btn-dark active" style="border-top-left-radius: 5px !important; border-radius: 0px;
        border-bottom: 1px solid #0d6efd2e;" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Login</a>
                ...
                <li class="nav-item text-center btn-dark" style="display: table-cell;
       background: #0d6efd2e;">
                  <a class="btn btn-dark" style="border-top-right-radius: 5px !important; border-radius: 0px;
