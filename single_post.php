...
<!-- start blog posts -->
  ...
  <!-- sidebar -->
    ...
    <div class="side" id="side" style="float: right; top: 0; right: 0; margin-top: 0; margin-right: 0 !important; padding-right: 0 !important; background-color: #1f1f1f; width: 30%;">  
      <div class="side-content" id="side_content" style="position: -webkit-sticky; position: sticky; top: 30px; margin-top: 75px; position: sticky; padding-left: 4%; padding-top: 2%;">
      <!-- recent posts -->
        <h4>
          Recent Posts
        </h4>
