...
<div class="blog_post mt-5 ms-5 p-5" style="width: 65%; background-color: #1f1f1f;">
    ...
    <nav class="mt-4" aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item" style="font-size: 12px;"><a href="#" class="text-decoration-none text-uppercase text-white"><i class="bi bi-person-circle"></i><?php echo $row['author']; ?></a></li>
