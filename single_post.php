...
<div class="blog_post mt-5 ms-5 p-5" style="width: 65%; background-color: #1f1f1f;">
    ...
    <nav class="mb-5" aria-label="breadcrumb" style="--bs-breadcrumb-divider: '>'; breadcrumb-divider-color: white;">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" style="font-size: 12px;"><a href="#" class="text-decoration-none text-uppercase" style="color: #03f8fc !important;"><?php echo $row['category']; ?></a></li>
