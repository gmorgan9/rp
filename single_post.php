...
<!-- start blog posts -->
  ...
  <div class="mb-5"></div>
  <div class="side" style="position: sticky; float: right; margin-top: 0; margin-right: 0 !important; padding-right: 0 !important; background-color: #1f1f1f; width: 30%; height: 100%;">  
    <h4>
      happy
    </h4>
  </div>
