...
<div class="top-hr d-flex">
  <hr style="width:50px;"> &nbsp; <img style="border: 1px solid #969696; border-radius: 100%; margin-top: -33px;" src="<?php echo $profile_picture; ?>" width="60px" height="60px" alt=""> <hr style="width:50px;">
</div>
