    ...
    <form action="" method="POST">
        ...
        <div class="modal_help float-end">
          ...
          <!-- Button trigger modal -->
            <button type="button" style="margin-top: -150px; background: none; color: inherit; border: none; cursor: pointer; outline: inherit;" class="badge text-bg-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal">
              Instructions
            </button>
